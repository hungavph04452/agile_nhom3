			...
			<div class="box">
				<form method="post" action="checkout4.html">
					...
					<ul class="nav nav-pills nav-justified">
						...
						<li><a href="checkout2.html"><i class="fa fa-truck"></i><br>Delivery
								Method</a></li>
						<li><a href="checkout3.jsp"><i class="fa fa-money"></i><br>Payment
								Method</a></li>
						<li class="active"><a href="#"><i class="fa fa-eye"></i><br>Order
								Review</a></li>
					</ul>
					...
					<div class="box-footer">
						<div class="pull-left">
							<a href="checkout3.jsp" class="btn btn-default"><i
...
<jsp:include page="_js.jsp"></jsp:include></html>