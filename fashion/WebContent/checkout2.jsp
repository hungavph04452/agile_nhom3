			...
			<div class="box">
				<form method="post" action="checkout3.jsp">
					...
					<ul class="nav nav-pills nav-justified">
						...
						<li class="active"><a href="#"><i class="fa fa-truck"></i><br>Delivery
								Method</a></li>
						<li class="disabled"><a href="#"><i class="fa fa-money"></i><br>Payment
								Method</a></li>
					...
					<div class="box-footer">
						<div class="pull-left">
							<a href="checkout1.jsp" class="btn btn-default"><i
								class="fa fa-chevron-left"></i>Back to Addresses</a>
						</div>
