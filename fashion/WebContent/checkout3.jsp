			...
			<div class="box">
				<form method="post" action="checkout4.jsp">
					...
					<ul class="nav nav-pills nav-justified">
						...
						<li><a href="checkout2.jsp"><i class="fa fa-truck"></i><br>Delivery
								Method</a></li>
						<li class="active"><a href="#"><i class="fa fa-money"></i><br>Payment
								Method</a></li>
						<li class="disabled"><a href="checkout4.jsp"><i
					...
					<div class="box-footer">
						<div class="pull-left">
							<a href="checkout2.jsp" class="btn btn-default"><i
